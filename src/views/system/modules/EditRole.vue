    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="角色名称">
          <a-input placeholder="输入角色名称" v-decorator="['name', [{required: true, message: '请输入角色名称！'}]]" />
        </a-form-item>

        <a-form-item label="描述">
          <a-input placeholder="输入角色描述" v-decorator="['description', {rules: [{required: false, message: '请输入角色描述'}]}]" />
        </a-form-item>
...
export default {
  ...
  created () {
    ...
    this.$watch('model', () => {
      ...
      this.checkedKeys = this.model.menus
    })
  },
  methods: {
