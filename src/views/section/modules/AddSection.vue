    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="类型">
          <a-select show-search placeholder="请选择一个类型" option-filter-prop="children" style="width: 320px" v-decorator="['type', {rules: [{required: true, message: '请选择分类类型！'}]}]">
            <a-select-option value="0">
              绑定作者-仅展示短视频
            </a-select-option>
            <a-select-option value="1">
            ...
            <a-select-option value="5">
              绑定视频分类-仅展示长视频-footer
            </a-select-option>
            <a-select-option value="6">
              绑定视频分类-仅展示长视频五宫格-footer
            </a-select-option>
        ...
        <!--作者-->
        <a-form-item v-show="model && (model.type === 0||model.type === 1||model.type === 2||model.type === 3)" label="作者id">
