    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="类型">
          <a-select show-search placeholder="请选择一个类型" option-filter-prop="children" style="width: 180px" v-decorator="['type', {rules: [{required: true, message: '请选择分类类型！'}]}]">
            <a-select-option value="0">
              类型0
            </a-select-option>
            <a-select-option value="1">
...
// 表单字段
const fields = ['title', 'position', 'type']
